...
echo "## Adding start-up Dashboard ##"
curl -XPOST -i http://admin:admin@localhost:3000/api/dashboards/db --data-binary @./dashboards/startup.json -H "Content-Type: application/json"
